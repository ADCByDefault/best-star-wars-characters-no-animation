var VanillaTilt = (function () {
    ...
    class VanillaTilt {
        constructor(element, settings = {}) {
            ...
            this.glare = VanillaTilt.isSettingTrue(
                this.settings.glare
            );
        ...
        onDeviceOrientation(event) {
            ...
            if (this.gyroscopeSamples > 0) {
                ...
                if (this.gammazero === null) {
                    ...
                    this.gammazero =
                        (event.gamma + this.lastgammazero) /
                        2;
                    this.betazero =
                        (event.beta + this.lastbetazero) /
                        2;
                }
            ...
            const degreesPerPixelX =
                totalAngleX / this.width;
            const degreesPerPixelY =
                totalAngleY / this.height;
        ...
        getValues() {
            ...
            let tiltX = (
                this.reverse *
                (this.settings.max -
                    x * this.settings.max * 2)
            ).toFixed(2);
            let tiltY = (
                this.reverse *
                (y * this.settings.max * 2 -
                    this.settings.max)
            ).toFixed(2);
            let angle =
                Math.atan2(
        ...
        prepareGlare() {
            ...
            if (!this.glarePrerender) {
                ...
                const jsTiltGlareInner =
                    document.createElement("div");
                jsTiltGlareInner.classList.add(
                    "js-tilt-glare-inner"
                );
